  ...
  return (
    <div id='shop' className='w-full lg:px-[170px] px-[20px] lg:pt-[150px] pt-[60px] pb-[0px] bg-gray-300 flex lg:flex-row flex-col justify-center items-start'>
      <div className='lg:w-[50%] w-full'>
        <img data-aos="slide-right" data-aos-delay="200" src={frame} alt="" className='z-10' />
      </div>
      <div className='lg:w-[50%] w-full z-20 flex flex-col justify-center items-start lg:gap-[100px] gap-[70px] lg:ml-[-50px] lg:mt-[-60px]'>
        ...
        <div data-aos="slide-up" data-aos-delay="400" className='bg-white lg:p-12 p-8 lg:w-[90%] w-full flex flex-col justify-center items-start gap-[45px]'>
          <h1 className='text-[65px] font-Lobster leading-[65px]'>Ice cream & vegan ice cream</h1>
          <p className='text-[20px]'>Massa ultricies mi quis hendrerit. Ac ut consequat semper viverra nam. Libero id faucibus nisl tincidunt eget nullam non nisi est. Arcu odio ut sem nulla. Amet tellus cras adipiscing enim. Et magnis dis parturient montes. Imperdiet sed euismod nisi porta lorem mollis.</p>
